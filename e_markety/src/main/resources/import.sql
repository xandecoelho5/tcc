...
INSERT INTO PEDIDO(DATA, TOTAL, TIPO_ENTREGA, STATUS, OBSERVACAO, USUARIO_ID, EMPRESA_ID) VALUES ('2021-05-01', 625.00, 'RETIRADA', 'REALIZADO', 'No Observation!!', 2, 1);
INSERT INTO PEDIDO(DATA, TOTAL, TIPO_ENTREGA, STATUS, OBSERVACAO, USUARIO_ID, EMPRESA_ID) VALUES ('2022-05-01', 85.00, 'RETIRADA', 'CONFIRMADO', 'I will arrive in two hours', 2, 1);
INSERT INTO PEDIDO(TOTAL, TIPO_ENTREGA, STATUS, OBSERVACAO, USUARIO_ID, EMPRESA_ID) VALUES (36.00, 'RETIRADA',  'PRONTO_PARA_RETIRADA', 'Hahahaha troller', 2, 1);
INSERT INTO PEDIDO(DATA, TOTAL, TIPO_ENTREGA, HORARIO_ENTREGA, STATUS, OBSERVACAO, TAXA_ENTREGA, USUARIO_ID, ENDERECO_ID, EMPRESA_ID) VALUES ('2022-09-09', 22.00, 'ENTREGA', '2022-09-09 16:00:00', 'PRONTO_PARA_ENTREGA', 'Please deliver the order as soon as possible', 7, 2, 1, 1);
INSERT INTO PEDIDO(DATA, TOTAL, TIPO_ENTREGA, HORARIO_ENTREGA, STATUS, OBSERVACAO, TAXA_ENTREGA, USUARIO_ID, ENDERECO_ID, EMPRESA_ID) VALUES ('2022-08-08', 95.00, 'ENTREGA', '2022-08-08 14:00:00', 'SAIU_PARA_ENTREGA', 'Vem rápido que tô faminto...', 12, 2, 2, 1);
INSERT INTO PEDIDO(DATA, TOTAL, TIPO_ENTREGA, HORARIO_ENTREGA, STATUS, OBSERVACAO, TAXA_ENTREGA, USUARIO_ID, ENDERECO_ID, EMPRESA_ID) VALUES ('2022-07-07', 125.00, 'ENTREGA', '2022-07-07 12:00:00', 'ENTREGUE', 'Aaaaaaaaaaaaaaiioooooooooooooooouuu', 7, 2, 1, 1);
